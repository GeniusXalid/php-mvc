...
/***** Stevie Ray Vaughan */
#gaia_content.grid_stevie_ray_vaughan #bd .yui-b {
	width:130px;
}
#gaia_content.grid_stevie_ray_vaughan #bd #yui-main .yui-b{
    width:auto;
    margin-right:140px;
}
...
<!-- START GRID: STEVIE RAY VAUGHAN -->
<div id="gaia_content" class="grid_stevie_ray_vaughan yui-t4">
	<? if (isset($zones['hd'])) : ?>
        <!-- START HEADER -->
        <div id="hd">
