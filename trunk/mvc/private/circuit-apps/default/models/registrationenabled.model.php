 ...
 */
class Default_RegistrationEnabled_CircuitModel
{
   /**
    * Execute the model
    ...
    */
    ...
    {
        if( SC::isEmpty('board_config.registration_disable') ) return TRUE;
        $observer->set('error.code', GENERAL_MESSAGE);
        $observer->set('error.title', 'Registration Disabled');
        $observer->set('error.message', 'The registration section of the site is currently disabled.');
