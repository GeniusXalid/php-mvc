...
/***** David Bowie */
#gaia_content.grid_david_bowie #bd .yui-b .yui-g .yui-u{
	width:470px;
}
#gaia_content.grid_david_bowie #bd #yui-main{
	height:250px;
	margin:0 0 10px 0;
	overflow:hidden;
}
...
<!-- START GRID: DAVID BOWIE -->
<div id="gaia_content" class="grid_david_bowie">
	<? if (isset($zones['hd'])) : ?>
        <!-- START HEADER -->
        <div id="hd">
