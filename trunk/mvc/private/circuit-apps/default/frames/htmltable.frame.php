 ...
 * @return string
 */
 class Default_HtmlTable_CircuitFrame
 {
    function execute( & $controller )
    {
        $observer =& $controller->getObserver();
        return $this->render($observer->get('default.htmltable'));
    }
    ...
    function render($params)
    {
        ...
        if (!isset($params['loop'])) {
           trigger_error("html_table: missing 'loop' parameter", E_USER_ERROR);
            return;
        }
